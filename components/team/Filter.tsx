...
export default function TeamFilterBar() {
  return (
    <div className="w-full px-4 pb-4 pt-0 bg-white">
      ...
      <h3 className="text-sm font-medium text-gray-700 mb-2">Đội ngũ</h3>

      <div className="flex flex-col xl:flex-row gap-4 items-end">
        
        {/* Vùng 4 ô Input/Select */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1 flex-1 w-full">
          {/* 1. Mã nhân viên */}
          <Input
            type="text"
          ...
          {/* 3. Chức vụ */}
          <Select>
            {/* UPDATE: Thêm 'w-full' để ô này giãn bằng ô Input, và 'px-3' để text căn lề giống Input */}
          ...
          {/* 4. Khu vực - Nằm ngay cạnh ô thứ 3 nhờ Grid Layout */}
          <Select>
            {/* UPDATE: Thêm 'w-full' và class tương tự ô thứ 3 */}
            <SelectTrigger className="bg-gray-200 border-transparent focus:ring-offset-0 text-gray-500 h-8 text-xs w-full px-3">
